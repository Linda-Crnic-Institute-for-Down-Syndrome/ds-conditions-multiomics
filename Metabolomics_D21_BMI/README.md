# Linear modeling of D21 plasma LC-MS metabolites vs. BMI
...
This workflow performs linear regression modeling of **LC-MS plasma metabolites measurements** to evaluate associations with BMI in participants from the [Human Trisome Project](https://www.trisome.org/) (HTP) in individuals without Down syndrome (D21). The goal is to identify metabolites significantly associated with BMI while adjusting for confounder covariates.
...
```         
Metabolomics_D21_BMI/ 
  ├── Metabolomics_D21_BMI_lm.R    # Main analysis script 
