# Linear modeling of D21 plasma SOMAscan proteins vs. BMI
...
This workflow performs linear regression modeling of **SOMAscan plasma protein measurements** to evaluate associations with BMI in participants from the [Human Trisome Project](https://www.trisome.org/) (HTP) in individuals without Down syndrome (D21). The goal is to identify proteins significantly associated with the BMI while adjusting for confounder covariates.
...
```         
SOMAscan_D21_BMI/ 
  ├── SOMAscan_D21_BMI_lm.R    # Main analysis script 
