## DESeq2 analysis of whole-blood bulk RNA-seq across co-occurring conditions: T21 controls vs. D21
...
This workflow performs linear regression modeling of **whole-blood bulk RNA-seq measurements** to evaluate associations with co-occurring clinical conditions in participants from the [Human Trisome Project](https://www.trisome.org/) (HTP) in individuals with (T21) and without (D21) Down syndrome. The goal is to identify genes significantly associated with the co-occurring conditions while adjusting for confounder covariates.

This analysis focuses exclusively on comparisons between individuals with Down syndrome and without any co-occurring condition and D21s (with or without co-occurring conditions).
...
## Repository contents  
```         
RNAseq_T21_controls_vs_D21_DESeq2/ 
  ├── RNAseq_T21_controls_vs_D21_DESeq2.R    # Main analysis script 
...
* [Human gencode release v33](https://www.gencodegenes.org/human/release_33.html) or directly as [GTF file](https://ftp.ebi.ac.uk/pub/databases/gencode/Gencode_human/release_33/gencode.v33.basic.annotation.gtf.gz) 
