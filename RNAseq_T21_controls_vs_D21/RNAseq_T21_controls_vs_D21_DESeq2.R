################################################
# Title: Differential abundance analysis of whole-blood transcriptome in T21 controls per condition vs. D21
# Author(s):
#   - Srija Chillamcherla
#   - Matthew Galbraith
# affiliation(s):
...
out_file_prefix <- "RNAseq_T21_controls_vs_D21_DESeq2.R_" # should match this script title
...
v_plot <- all_cond_transcriptome_DESeq2_data_final_results %>%
  ...
  volcano_plot_lab(
    title="Diff. abundance of genes in Cognitive decline (T21 controls vs. D21) - DESeq2",
