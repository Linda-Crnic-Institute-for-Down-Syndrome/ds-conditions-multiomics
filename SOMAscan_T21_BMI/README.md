...
This workflow performs linear regression modeling of **SOMAscan plasma protein measurements** to evaluate associations with BMI in participants from the [Human Trisome Project](https://www.trisome.org/) (HTP) in individuals with Down syndrome (DS). The goal is to identify proteins significantly associated with the BMI while adjusting for confounder covariates.
...
```         
SOMAscan_T21_BMI/ 
  ├── SOMAscan_T21_BMI_lm.R    # Main analysis script 
