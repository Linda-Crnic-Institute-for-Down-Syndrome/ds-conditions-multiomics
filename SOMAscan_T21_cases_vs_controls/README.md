# Linear modeling of SOMAscan plasma proteins across co-occurring conditions: T21 cases vs. controls
...
This workflow performs linear regression modeling of **SOMAscan plasma protein measurements** to evaluate associations with co-occurring clinical conditions in participants from the [Human Trisome Project](https://www.trisome.org/) (HTP) in individuals with Down syndrome (DS). The goal is to identify proteins significantly associated with the co-occurring conditions while adjusting for confounder covariates.
