## Beta regression modeling of CyTOF FlowSOMv2 Mass cytometry across co-occurring conditions: T21 controls vs. D21
...
This workflow performs beta regression modeling of **immune cell populations** to evaluate associations with co-occurring clinical conditions in participants from the [Human Trisome Project](https://www.trisome.org/) (HTP) in individuals with (T21) and without (D21) Down syndrome. The goal is to identify proteins significantly associated with the co-occurring conditions while adjusting for confounder covariates.
...
## Repository contents  
```         
CyTOF_T21_controls_vs_D21/ 
  ├── CyTOF_T21_controls_vs_D21_bm.R    # Main analysis script 
...
* [Mass cytometry](https://doi.org/10.7303/syn53185253)
