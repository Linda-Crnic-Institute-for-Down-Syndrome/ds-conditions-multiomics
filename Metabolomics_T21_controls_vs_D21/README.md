# Linear modeling of LC-MS plasma metabolites across co-occurring conditions: T21 Controls vs. D21
...
This workflow performs linear regression modeling of **LC-MS plasma metabolites measurements** to evaluate associations with co-occurring clinical conditions in participants from the [Human Trisome Project](https://www.trisome.org/) (HTP) in individuals with (T21) and without (D21) Down syndrome. The goal is to identify metabolites significantly associated with the co-occurring conditions while adjusting for confounder covariates.
...
```         
Metabolomics_T21_controls_vs_D21/ 
  ├── Metabolomics_T21_controls_vs_D21_km.R    # Main analysis script 
