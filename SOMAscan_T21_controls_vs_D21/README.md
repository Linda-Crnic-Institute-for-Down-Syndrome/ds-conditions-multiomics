# Linear modeling of SOMAscan plasma proteins across co-occurring conditions: T21 controls vs. D21
...
This workflow performs linear regression modeling of **SOMAscan plasma protein measurements** to evaluate associations with co-occurring clinical conditions in participants from the [Human Trisome Project](https://www.trisome.org/) (HTP) in individuals with (T21) and without (D21) Down syndrome. The goal is to identify proteins significantly associated with the co-occurring conditions while adjusting for confounder covariates.
...
## Repository contents  
```         
SOMAscan_T21_controls_vs_D21/ 
  ├── SOMAscan_T21_controls_vs_D21_lm.R    # Main analysis script 
