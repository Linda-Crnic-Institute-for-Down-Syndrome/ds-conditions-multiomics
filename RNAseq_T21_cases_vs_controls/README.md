## DESeq2 analysis of whole-blood bulk RNA-seq across co-occurring conditions: T21 cases vs. controls
...
This workflow performs linear regression modeling of **whole-blood bulk RNA-seq measurements** to evaluate associations with co-occurring clinical conditions in participants from the [Human Trisome Project](https://www.trisome.org/) (HTP) in individuals with Down syndrome (DS). The goal is to identify genes significantly associated with the co-occurring conditions while adjusting for confounder covariates.
...
## Repository contents  
```         
RNAseq_T21_cases_vs_controls_DESeq2/ 
  ├── RNAseq_T21_cases_vs_controls_DESeq2.R    # Main analysis script 
