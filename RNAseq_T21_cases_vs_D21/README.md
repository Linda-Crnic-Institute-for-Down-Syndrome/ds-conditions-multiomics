## DESeq2 analysis of whole-blood bulk RNA-seq across co-occurring conditions: T21 cases vs. D21
...
This analysis focuses exclusively on comparisons between individuals with Down syndrome and with any co-occurring condition and D21s (with or without co-occurring conditions).
...
## Repository contents  
```         
RNAseq_T21_cases_vs_D21_DESeq2/ 
  ├── RNAseq_T21_cases_vs_D21_DESeq2.R    # Main analysis script 
