# Linear modeling of LC-MS plasma metabolites across co-occurring conditions: T21 cases vs. controls
...
This workflow performs linear regression modeling of **LC-MS plasma metabolites measurements** to evaluate associations with co-occurring clinical conditions in participants from the [Human Trisome Project](https://www.trisome.org/) (HTP) in individuals with Down syndrome (DS). The goal is to identify metabolites significantly associated with the co-occurring conditions while adjusting for confounder covariates.
...
```         
Metabolomics_T21_cases_vs_controls/ 
  ├── Metabolomics_T21_cases_vs_controls_lm.R    # Main analysis script 
