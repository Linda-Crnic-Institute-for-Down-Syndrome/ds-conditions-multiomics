################################################
# Title: Differential abundance analysis of immune cell populations in T21 cases per condition vs. D21
# Author(s):
#   - Srija Chillamcherla
#   - Matthew Galbraith
# affiliation(s):
...
out_file_prefix <- "CyTOF_T21_cases_vs_D21_bm.R_" # should match this script title
...
v_plot <- all_cond_cytof_betareg_data_final_results %>%
  ...
  volcano_plot_lab_lm(
    title= "Diff. abundance of cells in Hidradenitis suppurativa (T21 cases vs. D21) - beta regression",
