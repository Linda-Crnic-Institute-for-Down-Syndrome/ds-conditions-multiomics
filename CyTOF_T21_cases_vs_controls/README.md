## Beta regression modeling of CyTOF FlowSOMv2 Mass cytometry across co-occurring conditions: T21 cases vs. controls
...
This workflow performs beta regression modeling of **immune cell populations** to evaluate associations with co-occurring clinical conditions in participants from the [Human Trisome Project](https://www.trisome.org/) (HTP) in individuals with Down syndrome (DS). The goal is to identify cell clusters significantly associated with the co-occurring conditions while adjusting for confounder covariates.
...
## Repository contents  
```         
CyTOF_T21_cases_vs_controls/ 
  ├── CyTOF_T21_cases_vs_controls_bm.R    # Main analysis script 
