...
out_file_prefix <- "SOMAscan_T21_cases_vs_D21_lm.R_" # should match this script title
...
v_plot <- all_cond_aptamers_lm_data_final_results %>%
  ...
  volcano_plot_lab_lm(
    title="Diff. abundance of SOMAscan proteins in Obstructive sleep apnea (T21 cases vs. D21) - linear regression",
