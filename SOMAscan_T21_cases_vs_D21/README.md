# Linear modeling of SOMAscan plasma proteins across co-occurring conditions: T21 cases vs. D21
...
## Repository contents  
```         
SOMAscan_T21_cases_vs_controls/ 
  ├── SOMAscan_T21_cases_vs_controls_lm.R    # Main analysis script 
